...
function ShoppingListCard() {
  ...
  const handleDeleteSLClick: MouseEventHandler = () => {
    ...
    dispatch(deleteSL({ id: shoppingListId || '' }))
      .unwrap()
      .then(() => {
                        ...
                        {category[1].map((item) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className="shopping-list-card__item-pricePerUnit">{`$${item.pricePerUnit.toFixed(
                                2,
                              )}`}</span>
                              <span className="shopping-list-card__item-price">{`$${item.price.toFixed(
                                2,
                              )}`}</span>
                            </li>
                          );
